...
"\n\t        0\n\t        0\n\t        "+e+"\n\t        "+g).attr("width",e).attr("height",g).append("g").attr("class","chart")};h.normalizeDataframe=function(c){var e=a.keys(c),g=Object.assign({},c);e.forEach(function(a){c[a]instanceof Array||(g[a]=[c[a]])});return g};h.dataframeToArray=function(c){var e=a.keys(c);return c[e[0]]instanceof Array?c[e[0]].map(function(a,b){var g={};e.forEach(function(a){g[a]=c[a][b]});return g}):[c]};h.prototype.wrap=function(c,e){c.each(function(){for(var g=a.select(this),
b=g.text().split(/\s+/).reverse(),c=[],k,d=0,y=g.attr("y"),f=parseFloat(g.attr("dy")),h=g.text(null).append("tspan").attr("x",0).attr("y",y).attr("dy",f+"em");k=b.pop();)c.push(k),h.text(c.join(" ")),h.node().getComputedTextLength()>e&&(1<c.length&&(c.pop(),b.push(k),h.text(c.join(" "))),c=[],h=g.append("tspan").attr("x",0).attr("y",y).attr("dy",1.1*++d+f+"em"))})};h.prototype.tooltipFactory=function(a){return function(c){var g="";if(void 0!==a)for(var b=0;b<a.length;b+=1){var l=a[b].accessor(c);
void 0!==a[b].format&&(l=a[b].format(l));g+=a[b].label+": "+l+"\x3c/br\x3e"}return g}};h.prototype.lineDefaultTooltip=function(a,e,g,b,l,k,d){return function(c){var f="";d(c)&&(f="Series: "+d(c)+"\x3c/br\x3e");f+=a+": "+e(g(c))+"\x3c/br\x3e";return f+=b+": "+l(k(c))}};h.prototype.donutDefaultTooltip=function(a,e,g){return function(b){return a(b)+": "+e(b)+" ("+g(b)+")"}};h.mapMonthYearDataToSeries=function(a,e){var g=Object.assign({},{dateField:"x",yValue:"y",yPercent:"p"},e),b={name:"All Time",values:[]};
a[g.dateField].map(function(c,k){b.values.push({xValue:new Date(Math.floor(a[g.dateField][k]/100),a[g.dateField][k]%100-1,1),yValue:a[g.yValue][k],yPercent:a[g.yPercent][k]})});b.values.sort(function(a,b){return a.xValue-b.xValue});return[b]};h.prepareData=function(a,e){switch(e){case this.chartTypes.BOXPLOT:if(!a.CATEGORY.length)return null;e=a.CATEGORY.map(function(g,b){return{Category:a.CATEGORY[b],min:a.MIN_VALUE[b],max:a.MAX_VALUE[b],median:a.MEDIAN_VALUE[b],LIF:a.P10_VALUE[b],q1:a.P25_VALUE[b],
q3:a.P75_VALUE[b],UIF:a.P90_VALUE[b]}},a);return Object.values(e).reduce(function(a,b){return a.concat(b)},[]).length?e:null}};$jscomp.global.Object.defineProperties(h.prototype,{formatters:{configurable:!0,enumerable:!0,get:function(){return{formatSI:function(c){c=c||0;return function(e){return 1>e?Math.round(e,c):a.format(",.0s",e)(e)}}}}}});$jscomp.global.Object.defineProperties(h,{chartTypes:{configurable:!0,enumerable:!0,get:function(){return{AREA:"AREA",BOXPLOT:"BOXPLOT",DONUT:"DONUT",HISTOGRAM:"HISTOGRAM",
LINE:"LINE",TRELLISLINE:"TRELLISLINE"}}}});return h});
